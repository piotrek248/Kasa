...
{
    banknot_200=(float)b_200;
    banknot_100=(float)b_100;
    banknot_50=b_50;
    banknot_20=b_20;
    banknot_10=b_10;
    moneta_5=m_5;
...
void Kasa::otworz(){
    ...
    } else cout<<"Kasa jest już otwarta!";
}

void Kasa::zamknij(){
    if(!zamkniety){
        zamkniety = true;
        cout << "Kasa została zamknięta";
    } else cout<<"Kasa jest już zamknięta!";
}
...
void Kasa::dodaj(){
    ...
    } else cout << "Kasa jest zamknięta, przed wprowadzeniem zmian otworz kase.";
}
